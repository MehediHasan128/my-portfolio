...
const Navbar = () => {
  useGSAP(() => {
    gsap.fromTo("#navbar", {y: 200, opacity: 0}, {y: 0, opacity: "100%", duration: 1});
  }, []);

  return (
    <header id="navbar" className="fixed w-full z-100">
      <nav className="bg-text-primary w-[85%] mx-auto py-5 px-10 rounded-b-2xl">
        <div className="flex justify-between items-center">
          {/* Logo section */}
          <div className="flex items-center gap-2.5">
            <img className="max-w-14" src={logo} alt="logo" />
            <h1 className="text-logo text-3xl font-bold">Mehedi</h1>
          </div>
